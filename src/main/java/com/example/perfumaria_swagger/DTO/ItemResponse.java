...
@Schema(description = "Dados de resposta retornados após a criação de um item")
public record ItemResponse(
    @Schema(description = "ID único do item", example = "1")
    Integer id,
    @Schema(description = "Nome do item", example = "Perfume Floral")
    String nome,
    @Schema(description = "Nome da categoria do item", example = "Perfumes Femininos")
    ...
    String dtAquisicao,
    @Schema(description = "Lista de nomes das famílias/gêneros aromáticos", example = "['Floral', 'Cítrico', 'Amadeirado']")
    List<String> generos
) {
} 